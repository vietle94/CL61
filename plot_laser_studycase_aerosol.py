...
files_after = glob.glob("/media/viet/CL61/studycase/lindenberg/20250222/*.nc")
df_after_ = xr.open_mfdataset(files_after)
df_after = df_after_.sel(time=slice("2025-02-22 00:00:00", "2025-02-22 04:00:00"))
...
ax[1].set_title("2025-02-22", weight="bold")

...
df = xr.open_mfdataset(
    glob.glob("/media/viet/CL61/studycase/lindenberg/20240316/*.nc")
    + glob.glob("/media/viet/CL61/studycase/lindenberg/20240317/*.nc")
)
time_slice = slice("2024-03-16T20:00", "2024-03-17T04:00")
...
aod_ceilo = np.interp(
    910.55,
    np.array([870, 1020]),
    aod.loc["2024-03-17", ["AOD_870nm", "AOD_1020nm"]].iloc[0].values,
)
###################################################################################
# %%
model = xr.open_mfdataset(
    glob.glob("/media/viet/CL61/studycase/lindenberg/20240316/weather/*ecmwf.nc")
    + glob.glob("/media/viet/CL61/studycase/lindenberg/20240317/weather/*ecmwf.nc")
)
...
# %%
for z1 in np.arange(5000, h + 500, 100):
    z2 = z1 + 500
...
fig.savefig(
    "/media/viet/CL61/img/klett_Lindenberg_20240316.png", dpi=300, bbox_inches="tight"
)

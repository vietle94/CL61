...
df = xr.open_mfdataset(
    glob.glob("/media/viet/CL61/studycase/lindenberg/20240109/*.nc")
    + glob.glob("/media/viet/CL61/studycase/lindenberg/20240110/*.nc")
)
time_slice = slice("2024-01-09T20:00", "2024-01-09T23:00")
...
# %%
aod = pd.read_csv(
    "/media/viet/CL61/studycase/lindenberg/20240101_20241231_MetObs_Lindenberg.lev20",
    skiprows=6,
)
...
aod_ceilo = np.interp(
    910.55,
    np.array([870, 1020]),
    aod.loc["2024-01-09", ["AOD_870nm", "AOD_1020nm"]].iloc[-1].values,
)
###################################################################################
# %%
model = xr.open_mfdataset(
    glob.glob("/media/viet/CL61/studycase/lindenberg/20240109/weather/*ecmwf.nc")
    + glob.glob("/media/viet/CL61/studycase/lindenberg/20240110/weather/*ecmwf.nc")
)
...
# %%
for z1 in np.arange(3000, h + 500, 100):
    z2 = z1 + 500
...
fig.savefig(
    "/media/viet/CL61/img/klett_Lindenberg_20240109.png", dpi=300, bbox_inches="tight"
)

...
ax_dict["mean_case_x"].scatter(
    radiosonde["molBsc"] / 1000 / radiosonde["range"] ** 2 / 100,
    radiosonde["range"],
    s=1,
...
# ax_dict["mean_cal_x"].scatter(
#     df_mean.sel(internal_temperature_bins=18, range=slice(250, None)).xpol_ref,
#     df_mean.sel(internal_temperature_bins=18, range=slice(250, None)).range,
#     s=1,
#     c="C1",
# )
...
# ax_dict["mean_cal_x"].scatter(
#     df_mean.sel(internal_temperature_bins=18, range=slice(None, 250)).xpol_r,
#     df_mean.sel(internal_temperature_bins=18, range=slice(None, 250)).range,
#     s=1,
#     c="C1",
# )
...
ax_dict["std_case_x"].set_ylabel("Range [m]")
#####################################################################
...
# filtered = noise_filter_std(df_std.sel(internal_temperature_bins=18).xpol_r)
# filtered[:100] = df_std.sel(internal_temperature_bins=18).xpol_r[:100].values
# ax_dict["std_cal_x"].scatter(
#     filtered,
#     df_std.range,
#     s=1,
...
ax_dict["mean_case_x"].set_xlim(-1e-14, 3e-14)
ax_dict["mean_cal"].set_xlim(-1e-14, 3e-14)
ax_dict["mean_cal_x"].set_xlim(-1e-14, 3e-14)

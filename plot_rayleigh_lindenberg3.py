...
df = xr.open_mfdataset(
    glob.glob("/media/viet/CL61/studycase/lindenberg/20231017/*.nc")
    + glob.glob("/media/viet/CL61/studycase/lindenberg/20231018/*.nc")
)
time_slice = slice("2023-10-17T20:00", "2023-10-18T04:00")
...
###################################################################################
# bad aod because only available at 10am, when there is definitely different boundary aerosol
aod_ceilo = np.interp(
    910.55,
    np.array([870, 1020]),
    aod.loc["2023-10-18", ["AOD_870nm", "AOD_1020nm"]].iloc[0].values,
)
###################################################################################
# %%
model = xr.open_mfdataset(
    glob.glob("/media/viet/CL61/studycase/lindenberg/20231017/weather/*ecmwf.nc")
    + glob.glob("/media/viet/CL61/studycase/lindenberg/20231018/weather/*ecmwf.nc")
)
...
fig.savefig(
    "/media/viet/CL61/img/klett_Lindenberg_20231017.png", dpi=300, bbox_inches="tight"
)

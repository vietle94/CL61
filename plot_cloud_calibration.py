...
ax_flat[0].axvspan("2022-06-15", "2023-04-27", color="tab:brown", alpha=0.2, label="1.1.10")
ax_flat[0].axvspan("2023-04-28", "2025-01-01", color="tab:purple", alpha=0.2, label="1.2.7")
ax_flat[1].axvspan("2022-11-21", "2023-11-22", color="tab:brown", alpha=0.2, label="1.1.10")
ax_flat[1].axvspan("2023-11-23", "2025-01-01", color="tab:purple", alpha=0.2, label="1.2.7")
ax_flat[2].axvspan("2023-06-21", "2025-01-01", color="tab:purple", alpha=0.2, label="1.2.7")
ax_flat[3].axvspan("2024-03-01", "2025-01-01", color="tab:brown", alpha=0.2, label="1.1.10")
